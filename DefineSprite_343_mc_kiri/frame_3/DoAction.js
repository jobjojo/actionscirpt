/**
 * ActionScript code for `DefineSprite_343_mc_kiri`, frame 3's `DoAction` script.
 ...
 */
function DoAction_DefineSprite_343_mc_kiri_frame_3() {
   // Assuming 'this' refers to the mc_kiri MovieClip instance.
   // And `youko_mc` is a child MovieClip of 'this' or accessible.
   if (this.youko_mc) {
      this.youko_mc.cfftype = this.charatype; // Assign Kiri's charatype to Youko's cfftype.
   }
}
