/**
 * ActionScript code for `DefineSprite_343_mc_kiri`, frame 144's `DoAction` script.
 ...
 * sequence for Kiri by giving a final boost and resetting game control states.
 *
 ...
 */
function DoAction_DefineSprite_343_mc_kiri_frame_144() {
...
class mc_kiri extends GameCharacter { // Extending GameCharacter as per previous conversion
   ...
   // Method representing the actions of frame 144
   onFrame144Action() {
      if (window.control) {
