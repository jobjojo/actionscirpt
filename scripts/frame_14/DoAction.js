/**
 * ActionScript code for `frame_14`, `DoAction` script (root timeline).
 ...
 *
 * This is identical to the script in `frame_10/DoAction.txt` and `frame_18/DoAction.txt`.
 *
 * In JavaScript, this translates to a direct call to a `nextact()` method
 * on the corresponding display object.
 */
function DoAction_frame_14() {
