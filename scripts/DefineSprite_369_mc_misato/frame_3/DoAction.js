/**
 * ActionScript code for `DefineSprite_369_mc_misato`, frame 3's `DoAction` script.
 ...
 * and `DefineSprite_350_mc_miki/frame_3/DoAction.txt`.
 *
 ...
 */
function DoAction_DefineSprite_369_mc_misato_frame_3() {
   // Assuming 'this' refers to the mc_misato MovieClip instance.
   // And `youko_mc` is a child MovieClip of 'this' or accessible.
   if (this.youko_mc) {
      this.youko_mc.cfftype = this.charatype; // Assign Misato's charatype to Youko's cfftype.
   }
}
